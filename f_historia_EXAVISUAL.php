...
<div class="col-lg-6">
  ...
  <div class="form-group">
                ...
                <div class="col-lg-5">
                  <textarea name="revision[agudeza_texto_sin_correccion]" class="form-control" rows="4" id="descripcion1"></textarea>
                </div>
              </div>
<div class="col-lg-6">
     ...
     <div class="form-group">
                <label for="descripcion1" class="col-lg-3 control-label"></label>
                <div class="col-lg-5">
                  <textarea name="revision['agudeza_texto_con_correccion']" class="form-control" rows="4" id="descripcion1"></textarea>
                </div>
              </div>
</div>
<div class="col-lg-12">
...
<div class="col-lg-6">
  ...
  <div class="form-group">
                <label for="descripcion1" class="col-lg-3 control-label"></label>
                <div class="col-lg-5">
                  <textarea name="revision['agudeza_texto_vp_sin_correccion']" class="form-control" rows="4" id="descripcion1"></textarea>
                </div>
              </div>
<div class="col-lg-6">
     ...
     <div class="form-group">
                <label for="descripcion1" class="col-lg-3 control-label"></label>
                <div class="col-lg-5">
                  <textarea name="revision['agudeza_vp_con_correccion']" class="form-control" rows="4" id="descripcion1"></textarea>
                </div>
              </div>
